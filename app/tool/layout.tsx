...
import { ALL_MODELS, PROVIDER_ORDER } from "@/lib/pricing";
...
export const metadata: Metadata = pageMetadata({
  ...
  description: `Upload a CSV or Excel file, describe what you need in plain English, and OpenClay researches every row with AI and live web search. ${ALL_MODELS.length} models across ${PROVIDER_ORDER.length} providers. Bring your own API key — no platform fee.`,
  path: "/tool",
  keywords: [
